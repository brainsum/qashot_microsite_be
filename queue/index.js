...
const queueProcessor = require('./src/lib/queue-processor');
...
app.get('/', function (req, res) {
    return res.status(200).json({ message: 'Microsite queue reporting in.'});
});
...
const run = async () => {
    ...
    const loopMessage = queueProcessor.loop();
